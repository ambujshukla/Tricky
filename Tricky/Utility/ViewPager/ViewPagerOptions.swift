...
class ViewPagerOptions {
    ...
    fileprivate struct Color {
        ...
        static let tabViewBackground = UIColor(colorLiteralRed: 107.0/255.0, green: 191.0/255.0, blue: 108.0/255.0, alpha: 1.0)
        static let tabViewHighlight = UIColor(colorLiteralRed: 107.0/255.0, green: 191.0/255.0, blue: 108.0/255.0, alpha: 1.0)
        static let textDefault = UIColor(colorLiteralRed: 229.0/255.0, green: 244.0/255.0, blue: 231.0/255.0, alpha: 1.0)
