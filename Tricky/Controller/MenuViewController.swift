...
class MenuViewController: UIViewController , UITableViewDataSource , UITableViewDelegate, UIGestureRecognizerDelegate {
    ...
    func decorateUI ()
    {
        ...
        //, "My Post"
        self.menuData = ["Home".localized() ,"txt_block_users".localized() , "txt_contacts".localized() , "txt_favorite".localized() , "txt_language".localized() , "txt_filter_vulgar".localized() , "txt_block_unauthorized".localized(),"Display all anonymous post" , "Logout"];
